...
public class CompetitionService {
    ...
    public CompetitionService(CompetitionRepo competitionRepo, UserService userService,
                              AssignmentService assignmentService, CompetitionMapper competitionMapper) {
    ...
    @Transactional
    public CompetitionResponseDTO create(String title) {
